...
from shrag.search.factories.registry import register_search_client
...
def build_scienceon(config: dict[str, Any]) -> BaseSearchClient:
    from shrag.search.clients.scienceon_api_example import ScienceONAPIClient
    from shrag.search.scienceon_adapter import ScienceONAdapter
