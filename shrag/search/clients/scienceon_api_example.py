...
def main():
    ...
    # Read credentials from the canonical project-level credentials path.
    ...
    try:
        ...
        output_path_all = Path("outputs/search/search_results_all_fields.json")
...
if __name__ == "__main__":
    # Uses project-level credentials under configs/credentials.
    main()
