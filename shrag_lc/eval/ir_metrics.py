"""IR metrics, ported verbatim from
``experiments/shared/evaluate/metrics_ir.py`` (recall/precision/MRR/nDCG @k).
Kept identical so results are comparable with the original pipeline.
"""
